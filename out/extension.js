    ...
    vscode.languages.registerDocumentFormattingEditProvider('promela', {
        provideDocumentFormattingEdits: (document) => {
            ...
            for (let index = 0; index < document.lineCount; index++) {
                ...
                tabCounter -= (0, functions_1.NumberOfTabsToDecrease)(textString);
                const processedString = (textString.startsWith("::")) ?
                    (0, functions_1.ProcessString)(textString, tabCounter - 1) :
                    (0, functions_1.ProcessString)(textString, tabCounter);
                let range;
                if (index == 0) {
                ...
                tabCounter += (0, functions_1.NumberOfTabsToIncrease)(textString);
            }
            return result;
        }
    });
